...
(30 rows)
```
Following state diagram autogenerated from [src/main/resources/education.statemachine](https://github.com/igor-suhorukov/state_machine_example/blob/master/src/main/resources/education.statemachine)
![](stateMachineSource.png)